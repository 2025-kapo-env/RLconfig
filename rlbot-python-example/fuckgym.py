...
class Gym:
    ...
    def connect(self):
        ...
        try:
            ...
            #print("FUCKLFUCKFUCKFUCKFUCKFUCKFUCKFUCK")
...
if __name__ == "__main__":
    ...
    myhive.initialize(field_info = info["field_info1"], indices = info["indices1"])
    ophive.initialize(field_info = info["field_info2"], indices = info["indices2"])
    i = 0
    while(True):
        try:
