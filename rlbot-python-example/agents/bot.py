...
from agents.util.ball_prediction_analysis import find_slice_at_time
from agents.util.boost_pad_tracker import BoostPadTracker
from agents.util.drive import steer_toward_target
from agents.util.sequence import ControlStep, Sequence
from agents.util.vec import Vec3
...
class MyAgent:
    ...
    def __init__(self, field_info, indices):
    ...
    def act(self, packet: GamePacket, ball_prediction):
        """
